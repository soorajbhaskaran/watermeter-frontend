...
//JSX Code
    return (
      <section class="text-gray-900 body-font bg-gradient-to-r from-zinc-900 via-sky-900 to-zinc-800">
        <div class="container mx-auto flex px-5 py-0 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="title-font sm:text-4xl text-6xl mb-5 font-bold text-white">
              Kerala Water Authority Welcomes You..
            </h1>
            <p class="text-white text-xl">
              Kerala Water Authority is an autonomous authority established for
              the development and regulation of water supply and waste water

...
const Footer = () => (
   <footer id = "footer" class="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
          ...
          <div class="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div class="space-y-3">
              ...
              <ul class="space-y-1">
                ...
                <a rel="noopener noreferrer" href="#">ഞങ്ങളെ സമീപിക്കുക</a>
                </p>
                </li>
                <li>
                  <p class="flex items-center justify-center md:justify-start mb-4">
                  ...
                  <a rel="noopener noreferrer" href="#">പരാതികൾ</a>
                  </p>
                </li>
                <li>
                  <p class="flex items-center justify-center md:justify-start mb-4">
                  ...
                  <a rel="noopener noreferrer" href="#">ഡൗൺലോഡ്</a>
                  </p>
                </li>
                <li>
                  <p class="flex items-center justify-center md:justify-start mb-4">
                  ...
                  <a rel="noopener noreferrer" href="#">അതിവേഗ പണമടക്കൽ</a>
                  </p>
                </li>
              </ul>
            </div>
                ...
                <li>
                  <p class="flex items-center justify-center md:justify-start mb-4">
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home"
                      ...
                      <a rel="noopener noreferrer" href="#">കേരളാ വാട്ടർ അതോറിറ്റി, ജലഭവൻ, വെള്ളയമ്പലം, തിരുവനന്തപുരം,
                        കേരളം, ഇന്ത്യ 695033</a>
                      </p>
          ...
          <a rel="noopener noreferrer" href="#">
            +91 471 2738300</a>
                ...
                <li>
                  ...
                  <a rel="noopener noreferrer" href="#">പ്രവത്തന സമയം</a>
                  </p>
                    <p class="ml-4">

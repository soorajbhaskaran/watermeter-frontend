            ...
            <form>
              <div class="form-group mb-6">
                ...
                <input required type="text" class="form-control
                  ...
                  aria-describedby="emailHelp" placeholder="Name" value={name} onChange={(event) => {
                    setName(event.target.value);
                  }}/>
                
              </div>
              <div class="form-group mb-6">
                <label for="exampleInputPassword1" class="form-label inline-block mb-2 text-gray-700" >Consumer Number</label>
                <input required type="number" class="form-control block
                  ...
                  placeholder="CustomerId" value={consumer} onChange={(event) => {
              ...
              <div class="form-group mb-6">
                ...
                <input type="text" class="form-control block
                  ...
                  m-0
                  focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInputPassword1"
                  placeholder="Current Threshhold" value={threshold} onChange={(event) => {
              ...
              <button type="submit" class="
                ...
                transition
                duration-150
                ease-in-out" id="addcustomer" onClick={handleRegister}  disabled={loading}>{loading ? "Submitting":"Submit"}</button>
